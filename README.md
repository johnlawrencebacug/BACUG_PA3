...
## Objectives 
Use the same cars.csv dataset supplied for Experiment 3. Write the solutions in one Jupyter Note- book and import Pandas as pd. The dataset contains the Model column together with the vehicle variables used in the original experiment. 
...
* `import` pandas `as` pd
- This defines that pandas is recognized as pd.
* `cars = pd.read_csv('cars.csv')`
- Imports the file "cars.csv" to the notebook and is defined as "cars".
* `cars`
- Calls the variable with the file.
